#!/usr/bin/env python
"""
s7_custom_model_cifar10.py: This contains the model definition used in session7
based on the C1-T1-C2-T2-C3-T3-C4-O template, and has a RF = 66x66 (greater
than 44x44 as required) with ~58K parameters.
